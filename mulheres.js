...
const conectaBancoDados = require('./bancoDeDados') //aqui estou ligando ao arquivo banco de dados
conectaBancoDados() //chamando a função que conecta o banco de dados
...
//GET
async function mostraMulheres (requeste, response) {
    try {
